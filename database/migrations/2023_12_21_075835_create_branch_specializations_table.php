...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('branch_specializations', function (Blueprint $table) {
			...
			$table->integer('course_ranking')->default(0);	
			...
			$table->unique(['discipline_branch_id' ,'university_id','campus_id' , 'program_id', 'discipline_id', 'branch_id', 'attendance_id', 'duration_id', 'specialization_id','course_id'],'dsbr_uid_cmp_pr_dis_br_att_dur_sp_id');	
