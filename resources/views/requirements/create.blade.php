...
@section('breadcrumb')
	...
	<li class="breadcrumb-item active" aria-current="page">
		Create <span class="text-danger">Requirement</span> 
	</li>
@endsection
@section('content')
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('requirements.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="requirement" type="text" class="form-control @error('requirement') is-invalid @enderror" name="requirement" value="{{ old('requirement') }}" required autocomplete="requirement" autofocus>
