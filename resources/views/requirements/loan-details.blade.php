...
@section('info-content')
				<div style="padding:25px"> 				 	  
					...
					<div class="container-fluid"> <h4 class="p-3  text-center">Bank Loan Details</h4>
						<div class="row g-2">
							<div class="col-4">
								<div class="card p-3">
									<div class="row">
										<form method="POST" action="{{ route('requirements.loan-details') }}" >
											@csrf
											<div class="col-md-12">
							...
							<div class="col-8">
								<div class="card p-3">
									<table class="table table-bordered table-stripped text-center p-4">
										...
										<tbody>
											@foreach($bank_loans as $id=>$bank_loan)
												<tr>
													<td>{{$id+1}}</td>
													<td>{{$bank_loan->bank_name}}</td>
													<td>{{!empty($bank_loan->country)?$bank_loan->country->country:'***'}}</td>
												</tr>
											@endforeach
										</tbody>							  
									</table>							  
