...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('SOP Document') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('standard-operating-procedures.store') }}" file="true" enctype="multipart/form-data">
                        @csrf
						...
						<div class="row mb-3">
                            <label for="sop_documents1" class="col-md-4 col-form-label text-md-end">{{ __('Upload SOP Documents') }}</label>

                            <div class="col-md-6">
								<input type="file" id="sop_documents" class="form-control" name="sop_documents[]" multiple required>
