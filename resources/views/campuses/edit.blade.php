...
@section('breadcrumb')
	...
	Edit <span class="no-decoration text-danger">{{$campus->university->university}}</span> campus details
	</li>
@endsection
@section('content')
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('campuses.update',$campus->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="campus" type="text" class="form-control @error('campus') is-invalid @enderror" name="campus" value="{{ old('campus',$campus->campus) }}" required autocomplete="campus" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="code" maxlength="5" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code',$campus->code) }}" required autocomplete="code">
						...
						<div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" rows="3" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Description" >{{$campus->description}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website',$campus->website) }}" required autocomplete="website">
