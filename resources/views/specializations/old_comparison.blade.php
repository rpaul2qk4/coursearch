							...
							<div class="" role="alert1">
								...
								<ul class="cd-features-list">
									...
									<li>
										...
										<span>{{substr($sp_format->format->format, 0, 4)}}&nbsp;/&nbsp;<i style="font-size:14px" class="fa fa-{{$specialization->university->country->currency_icon}}"></i>&nbsp;{{$sp_format->fees}}</span>
										@endforeach		
									</li>
									<li>{{$specialization->apply_fee}}</li>
									...
									<li>
										<div onclick="window.open('https://{{$specialization->entry_requirements_link}}', '_blank', 'noopener, noreferrer');" style="cursor:pointer;">
											<a href="#" class="compare-btn">requirements</a>
										</div>
									</li>
									<li>
										<div onclick="window.open('https://{{$specialization->curriculum_link}}', '_blank', 'noopener, noreferrer');" style="cursor:pointer;">
											<a href="#" class="compare-btn">curriculum</a>
										</div>
									</li>
									<li>
										<div onclick="window.open('https://{{$specialization->scholorship_link}}', '_blank', 'noopener, noreferrer');" style="cursor:pointer;">
											<a href="#" class="compare-btn">scholorship</a>
										</div>
									</li>						
									<li>
										<div onclick="window.open('https://{{$specialization->catalogue_link}}', '_blank', 'noopener, noreferrer');" style="cursor:pointer;">
											<a href="#" class="compare-btn">catalogue</a>
										</div>
									</li>
									<li>
										<div onclick="window.open('https://{{$specialization->apply_link}}', '_blank', 'noopener, noreferrer');" style="cursor:pointer;">
											<a href="#" class="compare-btn">Apply</a>
										</div>
									</li>						
								</ul>
								<!-- .product -->
