...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">
		<a href="{{route('states.index',$country->id)}}" class="no-decoration">States</a>
	</li>	
	<li class="breadcrumb-item active" aria-current="page">
	Create	<span class="text-danger">{{$country->country}}</span> - state
	</li>
@endsection
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('states.store',$country->id) }}">
                        @csrf
