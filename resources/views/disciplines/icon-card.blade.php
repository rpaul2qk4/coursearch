 <a href="#" class="card icon-category border1 shadow-dark p-md-5 p-3 text-center lift" style="border-radius:30px;">
<!-- Image -->
...
<div class="card-footer px-0 pb-0 pt-6">
	...
	<p class="mb-0 line-clamp-1">Over {{$discipline->branch_specializations->count()}} Courses</p>
</div>
</a>