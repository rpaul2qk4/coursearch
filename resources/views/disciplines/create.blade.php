...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Create Discipline') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('disciplines.store') }}" file="true" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="discipline" type="text" class="form-control @error('discipline') is-invalid @enderror" name="discipline" value="{{ old('discipline') }}" required autocomplete="discipline" autofocus>
						...
						<!-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
								<div class="d-flex justify-content-between">
									...
									<div class="col-md-10">
										&nbsp;&nbsp;&nbsp;<span><i id="icon_display" class="fa fa-music fa-3x"></i></span>
									</div>
								</div>
                            </div>
