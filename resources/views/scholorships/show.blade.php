...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">
		<a href="{{route('scholorships.index')}}" class="no-decoration">Scholorship info documents</a>
	</li>
	<li class="breadcrumb-item active" aria-current="page">
	<span class="text-danger">Scholorship info document </span> Details
	</li>
@endsection
@section('content')
<div class="container">
                ...
                <div class="card-body">											
					<div class="row g-3">				
						...
						<div style="text-align:center">
						  <h2>{{$scholorship->country->country}} Docs Gallery</h2>
						...
						<div class="row mx-auto g-3" >
							<div class="col-sm-4" style="height:450px;overflow-y:scroll">
								@foreach($scholorship->upload_docs as $upload_doc)
																		
									<div class="col">
										@if($scholorship->doc_type=='pdf')
											<div class="card p-2">
