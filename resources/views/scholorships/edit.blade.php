...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">
		<a href="{{route('standard-operating-procedures.index')}}" class="no-decoration">Scholorship info documents</a>
	</li>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('scholorships.update',$scholorship->id) }}" file="true" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
								<select id="discipline_id" class="form-select" name="discipline_id" required>
									@foreach(DataHelper::getDisciplineOptions() as $key=>$value)
										@if($scholorship->discipline_id==$key)
						...
						<div class="row mb-3">
                            ...
                            <div class="col-md-6">
								<input type="file" id="scholorship_documents" class="form-control" name="scholorship_documents[]" multiple>
