                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('attendances.update',$attendance->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="attendance" type="text" class="form-control @error('attendance') is-invalid @enderror" name="attendance" value="{{ old('attendance',$attendance->attendance) }}" required autocomplete="attendance" autofocus>
