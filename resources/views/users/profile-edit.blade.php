...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">
		<a href="{{route('users.profile',$user->id)}}" class="no-decoration">Profile</a>
	</li>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">{{ __('Profile Edit') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('users.profile-update',$user->id) }}" file="true" enctype="multipart/form-data">
                        @csrf
