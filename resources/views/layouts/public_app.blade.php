...
<head>
    ...
    <title>{{ config('app.name', 'Attic') }}</title>
...
<body class="bg-light" style="padding-top: 90px;">
            ...
            <div class="modal-content">
                ...
                <div class="collapse show" id="collapseSignin" data-bs-parent="#accountModal">
                    <div class="modal-header">
                        <h5 class="modal-title">Log In to Your Attic Account!</h5>
    ...
    <!-- NAVBAR
    ================================================== -->
    <header class="navbar navbar-expand-xl navbar-light fixed-top bg-white border-bottom py-2 py-xl-4">
